...
<div class="event">
    ...
    <div class="event-main">
        ...
        <ul class="event-list">
            <div class="event__main_title">{translateText('player2', 'Скучно? Самое время собрать 160 коробок от Санты! Отправляйся на поиски по всему штату и обменивай полученные подарки на крутые призы в этом меню, либо на FlyCoins у NPC Санта.')}</div>
