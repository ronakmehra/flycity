    ...
    other: {
        death: {//Игрока убивают
            desc: `Если Вы заметили нарушение правил сервера, то обратитесь к администрации. Для этого используйте команду /report. 
                    Правила сервера можно узнать на форуме, который можно открыть по ссылке: https://forum.flycityrp.com
        ...
        demorgan: {//Когда игрок получил деморган
            desc: "Вы получили наказание за нарушение правил. Используйте команду /time, чтобы узнать причину и срок наказания. Если Вы не согласны с наказанием, то можете оставить жалобу на администратора на форуме https://forum.flycityrp.com",
        },
