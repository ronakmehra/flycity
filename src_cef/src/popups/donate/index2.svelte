...
<div id="donatepopup">
    ...
    <div class="donatepopup__main">
        ...
        <div class="popup__subtitle">{translateText('popups', 'Пополняйте RB-счёт прямо из игры!  За FlyCoins можно сменить ник, снять варн, купить премиум-одежду, покрутить кейсов, купить подписку, вип-статус, обменять на игровую валюту и сделать еще много всего интересного. Спасибо тебе!')}</div>
