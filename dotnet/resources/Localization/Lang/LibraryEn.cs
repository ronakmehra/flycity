...
EnText[DataName.Greetings1] = "Welcome to FlyCity Roleplay !{{#00C6FF}}FlyCity!{{#FFF}} and thank you from the bottom of our hearts for being with us now ❤️"; // NOT WORKING
 ...
 EnText[DataName.Greetings5] = "You can find a lot of useful information about the project on our Wikipedia - !{{#Ff3333}}wiki.flycityrp.com!{{#FFF}}."; // NOT WORKING
